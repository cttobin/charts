...
(function() {
    ...
    const dateData = [
        { 'year': new Date(2010, 1, 1), 'sales': 1000, 'department': 'B' },
        { 'year': new Date(2011, 1, 1), 'sales': 2000, 'department': 'A' },
        { 'year': new Date(2012, 1, 1), 'sales': 3000, 'department': 'A' },
        { 'year': new Date(2013, 1, 1), 'sales': 800, 'department': 'A' },
        { 'year': new Date(2014, 1, 1), 'sales': 1250, 'department': 'A' },
        { 'year': new Date(2015, 1, 1), 'sales': 250, 'department': 'A' }
    ];
